...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(963, 761)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.continue_2 = QtWidgets.QPushButton(self.centralwidget)
        self.continue_2.setGeometry(QtCore.QRect(780, 570, 91, 51))
        ...
        self.rangemin = QtWidgets.QTextEdit(self.centralwidget)
        self.rangemin.setGeometry(QtCore.QRect(370, 570, 51, 41))
        self.rangemin.setObjectName("rangemin")
        self.rangemax = QtWidgets.QTextEdit(self.centralwidget)
        self.rangemax.setGeometry(QtCore.QRect(450, 570, 51, 41))
        ...
        self.label.setGeometry(QtCore.QRect(260, 570, 111, 41))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(430, 580, 67, 17))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(260, 650, 67, 17))
        self.label_3.setObjectName("label_3")
        self.step = QtWidgets.QTextEdit(self.centralwidget)
        self.step.setGeometry(QtCore.QRect(320, 640, 51, 41))
        self.step.setObjectName("step")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(480, 650, 67, 17))
        self.label_4.setObjectName("label_4")
        self.pro = QtWidgets.QTextEdit(self.centralwidget)
        self.pro.setGeometry(QtCore.QRect(520, 640, 51, 41))
        ...
        self.n_value = QtWidgets.QTextEdit(self.centralwidget)
        self.n_value.setGeometry(QtCore.QRect(900, 640, 51, 41))
        self.n_value.setObjectName("n_value")
        self.continue_3 = QtWidgets.QPushButton(self.centralwidget)
        self.continue_3.setGeometry(QtCore.QRect(520, 570, 51, 41))
        self.continue_3.setObjectName("continue_3")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(730, 680, 67, 17))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(870, 680, 67, 17))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.continue_2.setText(_translate("MainWindow", "Start"))
        ...
        self.continue_3.setText(_translate("MainWindow", "Set"))
